...
JSONEditor.defaults.editors.multiple = JSONEditor.AbstractEditor.extend({
  ...
  preBuild: function() {
    ...
    if(this.schema.oneOf) {
      ...
      if(!this.schema.type || this.schema.type === "any") {
        ...
        this.types = ['string','number','integer','boolean','array','null'];
  ...
  build: function() {
    ...
    this.switcher.addEventListener('change',function(e) {
      ...
      self.onChange(true);
      // Agreado para mostrar el Schema a cada nuevo elemento creado
      var data = { title: self.getTitle(), type: self.display_text.indexOf(this.value)}
      self.viewUsSchema(data);
    });
